...
export const GRAPHIC_DESIGN_IMAGES: StackedImage[] = [
  { id: 1, src: "/images/graphics/trigo.jpg", alt: "Graphic Design 1" },
  {
    id: 2,
    src: "/images/graphics/pythagoream-theorem.jpg",
    alt: "Graphic Design 2",
  },
  { id: 3, src: "/images/graphics/socio.jpg", alt: "Graphic Design 3" },
  { id: 4, src: "/images/graphics/homero.jpg", alt: "Graphic Design 4" },
];
